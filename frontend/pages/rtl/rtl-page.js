          ...
          <Card>
            ...
            <CardFooter stats>
              <div className={classes.stats}>
                ...
                <a href="frontend/pages/rtl/rtl-page#pablo" onClick={(e) => e.preventDefault()}>
          ...
          <Card>
            <CardHeader color="primary">
              ...
              <p className={classes.cardCategoryWhite}>
                ...
                <a
                  target="_blank"
                  href="frontend/pages/rtl/rtl-page?ref=creativetime"
                >
                ...
                <a
                  target="_blank"
                  href="frontend/pages/rtl/rtl-page?ref=njsmd-rtl-page"
                >
                  الإبداعية تيم
                </a>
                . يرجى التحقق من{" "}
                <a href="frontend/pages/rtl/rtl-page#pablo" target="_blank">
                  وثائق كاملة
                </a>
                .
              </p>
