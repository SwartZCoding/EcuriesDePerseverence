    ...
    <Card>
      <CardHeader color="primary">
        ...
        <p className={classes.cardCategoryWhite}>
          ...
          <a
            target="_blank"
            href="frontend/pages/admin/notifications?ref=creativetime"
          >
            Material UI
          </a>{" "}
          and styled by{" "}
          <a
            target="_blank"
            href="frontend/pages/admin/notifications?ref=njsmd-notifications-page"
          >
            Creative Tim
          </a>
          . Please checkout the{" "}
          <a href="frontend/pages/admin/notifications#pablo" target="_blank">
            full documentation
          </a>
          .
        </p>
